...
/* ---------- Frases geek compartidas (bocadillos del inicio y de contacto) ----------
   Cada frase lleva su emoción para que el avatar del inicio cambie de modelo:
   happy (normal), actually (listillo/dato rebuscado), angry (cosas que molestan),
   sad (datos tristes), timidin (sonrojado, cosas personales/románticas). */
const CHARLA_GEEK = [
  // --- datos curiosos "listillo" (actually) ---
  { t: '¿Sabías? Mario se llamaba "Jumpman" en Donkey Kong', e: 'actually' },
  { t: '¿Sabías? Pac-Man nació de una pizza sin una rebanada', e: 'actually' },
  { t: 'El primer easter egg está en Adventure (Atari, 1979)', e: 'actually' },
  { t: 'Tetris se creó en la URSS en 1984', e: 'actually' },
  { t: 'Zelda se llama así por Zelda Fitzgerald', e: 'actually' },
  { t: 'En Metroid (1986) Samus sorprendió a todos: ¡era ella!', e: 'actually' },
  { t: 'La primera versión de Minecraft se hizo en 6 días', e: 'actually' },
  { t: 'GTA iba a ser un juego de policías... salió al revés', e: 'actually' },
  { t: 'Sonic tiene un solo ojo con dos pupilas. Míralo bien', e: 'actually' },
  { t: '¿Sabías? "Game Over" lo popularizó el arcade Space Invaders', e: 'actually' },
  { t: '¿Sabías? La cruceta (D-pad) la inventó Nintendo para Game & Watch', e: 'actually' },
  { t: '¿Sabías? Lara Croft iba a llamarse Laura Cruz', e: 'actually' },
  { t: '¿Sabías? Los Goombas son setas que traicionaron al Reino Champiñón', e: 'actually' },
  { t: '¿Sabías? Kratos significa "fuerza" en griego', e: 'actually' },
  { t: '¿Sabías? Steve de Minecraft no tiene nombre oficial... era "Steve?"', e: 'actually' },
  { t: '¿Sabías? El "blast processing" de Sega era casi puro marketing', e: 'actually' },
  { t: '¿Sabías? Pikachu viene de "pika" (chispa) y "chu" (ratón)', e: 'actually' },
  { t: '¿Sabías? Doom corre hasta en una calculadora y un test de embarazo', e: 'actually' },
  { t: '¿Sabías? Halo iba a ser un juego de estrategia para Mac', e: 'actually' },
  { t: '¿Sabías? El récord de Tetris (NES) cayó por el "rolling"', e: 'actually' },
  { t: '¿Sabías? Crash Bandicoot se llamaba "Willie the Wombat"', e: 'actually' },
  { t: '¿Sabías? Megaman es "Rockman" en Japón', e: 'actually' },
  { t: 'Actually... "RPG" es Role-Playing Game, no "muchos números"', e: 'actually' },
  { t: 'Actually... el rojo de Mario fue por los límites de paleta del NES', e: 'actually' },
  { t: 'Actually... cada fantasma de Pac-Man tiene su propia IA', e: 'actually' },
  { t: 'Easter egg: busca la vaca secreta en Diablo II', e: 'actually' },
  // --- frases icónicas y festivas (happy) ---
  { t: 'El Konami Code: ↑↑↓↓←→←→ B A', e: 'happy' },
  { t: '"It\'s-a me!"', e: 'happy' },
  { t: '"The cake is a lie" — Portal', e: 'happy' },
  { t: '"Es peligroso ir solo, toma esto" — Zelda', e: 'happy' },
  { t: '"¡Objection!" — Phoenix Wright', e: 'happy' },
  { t: '"Praise the sun \\[T]/" — Dark Souls', e: 'happy' },
  { t: '"Would you kindly?" — BioShock', e: 'happy' },
  { t: '"Do a barrel roll!" — Star Fox', e: 'happy' },
  { t: '"Stay a while and listen" — Diablo', e: 'happy' },
  { t: '"Nothing is true, todo está permitido" — Assassin\'s Creed', e: 'happy' },
  { t: '"The right man in the wrong place..." — Half-Life', e: 'happy' },
  { t: '"Cuando la vida te dé limones..." — Cave Johnson, Portal', e: 'happy' },
  { t: '"¡Es hora del Power-Up!"', e: 'happy' },
  { t: 'GG WP', e: 'happy' },
  { t: '¿Una partidita más? Solo una...', e: 'happy' },
  { t: 'No te rindas: ¡el siguiente intento es el bueno!', e: 'happy' },
  { t: '¿Speedrun o exploración? Yo me quedo con las dos', e: 'happy' },
  { t: 'Loot legendario incoming...', e: 'happy' },
  { t: 'Respawn en 3... 2... 1...', e: 'happy' },
  { t: 'Checkpoint guardado. Puedes seguir tranquilo', e: 'happy' },
  { t: 'Nivel de hype: AL MÁXIMO', e: 'happy' },
  // --- cosas que molestan (angry) ---
  { t: '"YOU DIED" — Dark Souls. Otra vez. OTRA VEZ.', e: 'angry' },
  { t: '"Hey! Listen!" — Navi. Sí, Navi, ya te escuché...', e: 'angry' },
  { t: 'Aún me arde cuando cierran un estudio con talento por puras cifras', e: 'angry' },
  { t: 'Años de hype y el juego sale a medio hacer... me hierve la sangre', e: 'angry' },
  { t: 'Microtransacciones en un juego de 70 dólares. ¿Es broma?', e: 'angry' },
  { t: 'Prometieron un mundo abierto vivo... y era un campo vacío', e: 'angry' },
  { t: 'Cancelar una saga querida por una hoja de cálculo. Genial.', e: 'angry' },
  { t: 'Cuando el remaster sale peor que el original de hace 20 años', e: 'angry' },
  // --- datos tristes (sad) ---
  { t: '"War never changes" — Fallout', e: 'sad' },
  { t: '"Snake? ¡SNAAAKE!" — Metal Gear', e: 'sad' },
  { t: '"Wake me up when you need me" — Halo', e: 'sad' },
  { t: '"Requiescat in pace" — Assassin\'s Creed', e: 'sad' },
  { t: 'Press F to pay respects', e: 'sad' },
  { t: 'Cuántos servidores online se apagaron para siempre... ahí murieron recuerdos', e: 'sad' },
  { t: 'Terminar un juego buenísimo y sentir ese vacío raro', e: 'sad' },
